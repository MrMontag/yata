...
void FileBlockReaderTest::readChunkTest_data()
{
    ...
    QTest::addColumn<qint64>("lines_before_start");
    ...
    QTest::newRow("one line") << qint64(0) << qint64(0) << qint64(1) << qint64(0) << qint64(15) << "This is line 1";
    QTest::newRow("2 lines") << qint64(0) << qint64(0) << qint64(2) << qint64(0) << qint64(30) << "This is line 1\nThis is line 2";
...
void FileBlockReaderTest::readChunkTest()
{
    ...
    QFETCH(qint64, lines_before_start);
    ...
    std::pair<qint64, qint64> result_pos = reader.readChunk(&line, start_pos, lines_before_start, num_lines);
